      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          ...
          <div className="px-8 py-10 flex flex-col items-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-1 self-start">Welcome To Verifind</h2>
            <p className="text-sm text-gray-400 mb-6 self-start">Sign in to your account</p>
            ...
            <p className="text-sm text-gray-500">
              ...
              <Link to="/signup" className="font-semibold hover:underline" style={{ background: "linear-gradient(90deg,#00AAFF,#6B30FF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
                Sign Up
              </Link>
            </p>
          </div>
