          ...
          <div className="px-8 py-10 flex flex-col items-center">
            ...
            <div className="flex items-center gap-2.5 mb-2">
              <svg width="32" height="32" viewBox="0 0 52 52" fill="none">
                <defs>
                  <linearGradient id="signup-lg" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-1 self-start">Create an account</h2>
            <p className="text-sm text-gray-400 mb-6 self-start">Start finding better deals today</p>
            ...
            <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
              ...
              <button
                ...
                style={{ background: isInvalid || loading ? undefined : "linear-gradient(90deg,#00AAFF,#6B30FF)" }}
              >
                {loading ? (
                  <>
