  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 pt-16 pb-14">
        ...
        >
          A centralized shopping platform that aggregates product listings from
          multiple retailers into one unified interface. Compare prices, read
          reviews, check trust scores, and track your favorites — all in one
          place.
        </p>
            ...
            return (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  ).style.boxShadow = `0 12px 40px ${member.color}28, 0 4px 16px rgba(0,0,0,0.08)`;
                  (
                    e.currentTarget as HTMLDivElement
      ...
      >
        ...
        <p className="text-gray-500 text-sm leading-relaxed max-w-xl mb-6">
          ...
          Whether online or in-store, find the best product at the best price,
          track your favorites, and make informed decisions with real-time data
      ...
      <div className="relative z-10 mx-4 mb-8">
        <div className="text-center mb-5">
          ...
          <p className="text-sm text-gray-400 mt-1">
            Join the Verifind community for deals, updates and more
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
          ...
          <a
            ...
            style={{
              background: "rgba(217, 129, 129, 0.65)",
              backdropFilter: "blur(14px)",
              WebkitBackdropFilter: "blur(14px)",
              border: "1px solid rgba(88,101,242,0.2)",
              boxShadow: "0 4px 20px rgba(88,101,242,0.08)",
              textDecoration: "none",
            }}
          >
            <div
          ...
          <a
            ...
            className="group flex items-center gap-4 px-5 py-5 rounded-2xl transition-all duration-200 hover:-translate-y-1"
            style={{
              background: "rgba(212, 136, 136, 0.65)",
              backdropFilter: "blur(14px)",
              WebkitBackdropFilter: "blur(14px)",
              border: "1px solid rgba(225,48,108,0.18)",
              boxShadow: "0 4px 20px rgba(225,48,108,0.07)",
              textDecoration: "none",
            }}
          >
            <div
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                Latest drops, marketplace highlights and updates
              </p>
            </div>
            <div
              className="flex-shrink-0 w-7 h-7 rounded-xl flex items-center justify-center"
              style={{ background: "rgba(189, 137, 154, 0.07)" }}
            >
              <svg
      ...
      {/* Footer */}
      <div
        className="relative z-10 w-full py-5 flex justify-center"
